...
test("identifyDocument detects W-2 and 1099-NEC", () => {
  expect(identifyDocument(fixture("gusto-w2.txt"))).toBe("W-2");
  expect(identifyDocument(fixture("1099-nec.txt"))).toBe("1099-NEC");
  expect(identifyDocument(fixture("adp-w2.txt"))).toBe("W-2");
});
...
test("mergeRegexAndAi flags disagreements", () => {
